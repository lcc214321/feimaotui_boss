...
(function (p) {
    ...
    (function (g) {
        var p = g.win.document, m = g.each, z = g.objectEach, A = g.pick, w = g.inArray, x = g.isNumber, B = g.splat, n,
            u = function (b, a) {
                this.init(b, a)
            };
        g.extend(u.prototype, {
            init: function (b, a) {
                ...
                var b =
                        this, a = this.options, d = a.googleSpreadsheetKey, f = this.columns, e = a.startRow || 0,
                    c = a.endRow || Number.MAX_VALUE, k = a.startColumn || 0, g = a.endColumn || Number.MAX_VALUE, h, q;
                d && jQuery.ajax({
                    dataType: "json",
                ...
                var d = this.rawColumns, f = this.columns, e = b.length, c, k, g, h, n = this.firstRowAsNames,
                    m = -1 !== w(a, this.valueCount.xColumns), p = [], v = this.chartOptions, r,
                ...
                m && b.mixed && (f[a] = d[a]);
                if (m && r && this.options.sort)for (a = 0; a < f.length; a++)f[a].reverse(), n && f[a].unshift(f[a].pop())
            }, dateFormats: {
                "YYYY-mm-dd": {
                ...
                for (b = 0; b < a.length; b += 1)for (c = a[b].getReferencedColumnIndexes(),
                ...
                if (d.complete || d.afterComplete) {
                    ...
                    if ("category" === a)for (c = 0; c < g.length; c++)for (h = g[c], e = 0; e < h.readers.length; e++)"x" === h.readers[e].configName && (h.readers[e].configName = "name");
        ...
        g.wrap(g.Chart.prototype, "init", function (b, a, d) {
            ...
            a && a.data ? g.data(g.extend(a.data, {
                afterComplete: function (e) {
                    var c, k;
                    if (a.hasOwnProperty("series"))if ("object" === typeof a.series)for (c = Math.max(a.series.length,
                        e.series.length); c--;)k = a.series[c] || {}, a.series[c] = g.merge(k, e.series[c]); else delete a.series;
                    a = g.merge(e, a);
                    b.call(f, a, d)
                }
            }), a) : b.call(f, a, d)
